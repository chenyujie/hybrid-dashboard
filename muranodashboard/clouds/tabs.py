...
class OverviewTab(tabs.Tab):
    name = _("Component")
    slug = "_service"
    template_name = 'clouds/_overview.html'
...
class ServiceLogsTab(tabs.Tab):
    name = _("Logs")
    slug = "service_logs"
    template_name = 'clouds/_logs.html'
    preload = False
...
class EnvironmentTopologyTab(tabs.Tab):
    name = _("Topology")
    slug = "topology"
    template_name = "clouds/_detail_topology.html"
    preload = False
